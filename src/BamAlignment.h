...
//  BamAlignment &BamAlignment::operator=(BamAlignment &rhs)
//  {
//    reset();
//
//    (*this).readBamRecord(rhs.getBamRecord());
//
//    return *this;
//  }
...
double cal_single_base_depth_oc(string chrom, uint64_t pos, samfile_t *fp, bam_index_t *idx_bam);
